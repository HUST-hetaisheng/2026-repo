...
\begin{tabular}{lcccc}
\hline
\rowcolor{green}Contestant (Season) & Actual Rank & Rank Rule Est. & Percent Rule Est. & Survival Advantage \\
\midrule
...
\begin{figure}[H]
    ...
    \caption{Sensitivity comparison between judges and fans. The $|t|$-statistic measures the strength of each factor's influence. Judges prioritize age (physical capability), while fans respond strongly to celebrity popularity. The dashed line indicates the $p=0.05$ significance threshold.}
