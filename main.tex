...
We recommend retaining the \textbf{percentage aggregation method} (sum of score shares) as the foundational aggregation rule, rather than adopting a ranking method.
\begin{itemize}
...
A strong negative correlation exists between contestant age and judge scores($\beta = -0.28, p = 0.002$).Each additional decade of age corresponds to an average decrease of approximately 2.8 points, reflecting the premium placed on the physical agility and stamina associated with youth in ballroom dancing.

\textbf{The Divergence of Fame and Skill.} 
A critical insight is the independence of professional Judges' scores show no statistically significant link to pre-existing celebrity popularity (p = 0.46). In contrast, popularity is a strong, significant predictor of fan vote share (p = 0.001). This confirms that while audience voting functions as a popularity contest, judge assessment remains effectively independent of contestant fame.
...
A clear dichotomy emerges: text{Judges} emphasize physical and technical factors (age, dance experience), while text{Fans} respond strongly to pre-existing popularity and social media presence. Notably, both groups reward athletes, suggesting physical discipline appeals to judges and audiences alike. This divergence supports the hybrid scoring system: judges uphold technical standards, while fan voting sustains viewer engagement.
...
\bibitem{Zhang2021} Zhang Jiaqi. (2021). A Study on the Development Status and Countermeasures of Dance Reality TV Shows. \textit{Southwestern University of Finance and Economics}. DOI:10.27412/d.cnki.gxncu.2021.002147.

\bibitem{Ren2016} Ren Shujiang. (2016). The Commodification of the Ideal: An Investigation and Reflection on Competition-Based Music Variety Shows. \textit{Journal of Southwest Jiaotong University (Social Sciences Edition)} 17(2), 68--76.

\bibitem{Warren2021} Warren, Derin. (2021). \textit{Audience Appeal: Why Can They Become Superstar Actors?} (Lin Siyun, Trans.). Huazhong University of Science and Technology Press.
\end{thebibliography}
