...
The data provided in the task is complete and clear. To facilitate calculations, we performed some processing. We marked cells with judges' scores of N/A as 0. We marked "whether born in the US" as a 0/1 variable. For eliminated contestants, we recorded the number of weeks of elimination. For the special case of a contestant withdrawing midway through the competition, we marked it to distinguish it and recorded the number of weeks of withdrawal. Additionally, we coded the dance partners.

Because the show's rules have changed twice, we labeled the data for different seasons according to the corresponding rules: seasons 1-2 were labeled "rank," seasons 3-27 were labeled "percent," and seasons 28-34 were labeled "bottom2."

To enrich the data required for Task 3, we used web scraping to collect contestants' weekly social media follower counts and search frequencies from social media and Google Trends during the competition. We also scraped the contestants' BMI and dance experience metrics.
