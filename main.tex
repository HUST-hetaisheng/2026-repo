...
As shown in the Figure~ref{}, we have also visualized the seasonal trends in the number of weeks and the variations in judges' scores across different seasons and weeks within each season. 
\begin{figure}[htbp]
    \centering
    ...
    \begin{subfigure}{0.48\textwidth}
        \centering
        \includegraphics[width=\linewidth]{fig4_judge_scores_3d.png}
