...
\date{\today}
\title{Balancing Professional Integrity and Popular Appeal: Evaluation and Optimization of the DWTS Scoring Mechanism
}
\begin{document}
...
{
\setlength{\parskip}{-2pt} % 段间距设为0
\renewcommand{\baselinestretch}{0.8} % 行距设为0.9倍（可按需调整，如 0.8）
\tableofcontents
}
\newpage
